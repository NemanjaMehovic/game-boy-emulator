...
private:
    ...
    void ldh_ar8_r8(uint16& regD, RegisterBits regDB, uint16& regS, RegisterBits regSB);
    ...
    const std::unordered_set<uint8> bad_opcodes = {
    ...
    const std::unordered_map<uint8, std::function<void()>> opcode_map = {
        ...
        {0x02, std::bind(&CPU::ld_ar16_r8, this, std::ref(BC), std::ref(AF), RegisterBits::High)},
        ...
        {0x0A, std::bind(&CPU::ld_r8_ar16, this, std::ref(AF), RegisterBits::High, std::ref(BC))},
        ...
        {0x12, std::bind(&CPU::ld_ar16_r8, this, std::ref(DE), std::ref(AF), RegisterBits::High)},
        ...
        {0x1A, std::bind(&CPU::ld_r8_ar16, this, std::ref(AF), RegisterBits::High, std::ref(DE))},
        ...
        {0x22, std::bind(&CPU::ld_ar16i_r8, this, std::ref(HL), std::ref(AF), RegisterBits::High)},
        ...
        {0x2A, std::bind(&CPU::ld_r8_ar16i, this, std::ref(AF), RegisterBits::High, std::ref(HL))},
        ...
        {0x32, std::bind(&CPU::ld_ar16d_r8, this, std::ref(HL), std::ref(AF), RegisterBits::High)},
        ...
        {0x3A, std::bind(&CPU::ld_r8_ar16d, this, std::ref(AF), RegisterBits::High, std::ref(HL))},
        ...
        {0x40, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(BC), RegisterBits::High)},
        {0x41, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(BC), RegisterBits::Low)},
        {0x42, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(DE), RegisterBits::High)},
        {0x43, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(DE), RegisterBits::Low)},
        {0x44, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(HL), RegisterBits::High)},
        {0x45, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(HL), RegisterBits::Low)},
        {0x46, std::bind(&CPU::ld_r8_ar16, this, std::ref(BC), RegisterBits::High, std::ref(HL))},
        {0x47, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::High, std::ref(AF), RegisterBits::High)},
        {0x48, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(BC), RegisterBits::High)},
        {0x49, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(BC), RegisterBits::Low)},
        {0x4A, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(DE), RegisterBits::High)},
        {0x4B, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(DE), RegisterBits::Low)},
        {0x4C, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(HL), RegisterBits::High)},
        {0x4D, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(HL), RegisterBits::Low)},
        {0x4E, std::bind(&CPU::ld_r8_ar16, this, std::ref(BC), RegisterBits::Low, std::ref(HL))},
        {0x4F, std::bind(&CPU::ld_r8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(AF), RegisterBits::High)},

        {0x50, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(BC), RegisterBits::High)},
        {0x51, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(BC), RegisterBits::Low)},
        {0x52, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(DE), RegisterBits::High)},
        {0x53, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(DE), RegisterBits::Low)},
        {0x54, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(HL), RegisterBits::High)},
        {0x55, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(HL), RegisterBits::Low)},
        {0x56, std::bind(&CPU::ld_r8_ar16, this, std::ref(DE), RegisterBits::High, std::ref(HL))},
        {0x57, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::High, std::ref(AF), RegisterBits::High)},
        {0x58, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(BC), RegisterBits::High)},
        {0x59, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(BC), RegisterBits::Low)},
        {0x5A, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(DE), RegisterBits::High)},
        {0x5B, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(DE), RegisterBits::Low)},
        {0x5C, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(HL), RegisterBits::High)},
        {0x5D, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(HL), RegisterBits::Low)},
        {0x5E, std::bind(&CPU::ld_r8_ar16, this, std::ref(DE), RegisterBits::Low, std::ref(HL))},
        {0x5F, std::bind(&CPU::ld_r8_r8, this, std::ref(DE), RegisterBits::Low, std::ref(AF), RegisterBits::High)},

        {0x60, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(BC), RegisterBits::High)},
        {0x61, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(BC), RegisterBits::Low)},
        {0x62, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(DE), RegisterBits::High)},
        {0x63, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(DE), RegisterBits::Low)},
        {0x64, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(HL), RegisterBits::High)},
        {0x65, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(HL), RegisterBits::Low)},
        {0x66, std::bind(&CPU::ld_r8_ar16, this, std::ref(HL), RegisterBits::High, std::ref(HL))},
        {0x67, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::High, std::ref(AF), RegisterBits::High)},
        {0x68, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(BC), RegisterBits::High)},
        {0x69, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(BC), RegisterBits::Low)},
        {0x6A, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(DE), RegisterBits::High)},
        {0x6B, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(DE), RegisterBits::Low)},
        {0x6C, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(HL), RegisterBits::High)},
        {0x6D, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(HL), RegisterBits::Low)},
        {0x6E, std::bind(&CPU::ld_r8_ar16, this, std::ref(HL), RegisterBits::Low, std::ref(HL))},
        {0x6F, std::bind(&CPU::ld_r8_r8, this, std::ref(HL), RegisterBits::Low, std::ref(AF), RegisterBits::High)},

        {0x70, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(BC), RegisterBits::High)},
        {0x71, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(BC), RegisterBits::Low)},
        {0x72, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(DE), RegisterBits::High)},
        {0x73, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(DE), RegisterBits::Low)},
        {0x74, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(HL), RegisterBits::High)},
        {0x75, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(HL), RegisterBits::Low)},
        {0x76, std::bind(&CPU::halt, this)},
        {0x77, std::bind(&CPU::ld_ar16_r8, this, std::ref(HL), std::ref(AF), RegisterBits::High)},
        {0x78, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(BC), RegisterBits::High)},
        {0x79, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(BC), RegisterBits::Low)},
        {0x7A, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(DE), RegisterBits::High)},
        {0x7B, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(DE), RegisterBits::Low)},
        {0x7C, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(HL), RegisterBits::High)},
        {0x7D, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(HL), RegisterBits::Low)},
        {0x7E, std::bind(&CPU::ld_r8_ar16, this, std::ref(AF), RegisterBits::High, std::ref(HL))},
        {0x7F, std::bind(&CPU::ld_r8_r8, this, std::ref(AF), RegisterBits::High, std::ref(AF), RegisterBits::High)},
        ...
        {0xE0, std::bind(&CPU::ldh_a8_r8, this, std::ref(AF), RegisterBits::High)},
        {0xE1, std::bind(&CPU::pop_r16, this, std::ref(HL))},
        {0xE2, std::bind(&CPU::ldh_ar8_r8, this, std::ref(BC), RegisterBits::Low, std::ref(AF), RegisterBits::High)},
        ...
        {0xEA, std::bind(&CPU::ld_a16_r8, this, std::ref(AF), RegisterBits::High)},
        {0xEE, std::bind(&CPU::xor_n8, this)},
        {0xEF, std::bind(&CPU::rst, this)},

        {0xF0, std::bind(&CPU::ldh_r8_a8, this, std::ref(AF), RegisterBits::High)},
        {0xF1, std::bind(&CPU::pop_r16, this, std::ref(AF))},
        {0xF2, std::bind(&CPU::ldh_r8_ar8, this, std::ref(AF), RegisterBits::High, std::ref(BC), RegisterBits::Low)},
        ...
        {0xFA, std::bind(&CPU::ld_r8_a16, this, std::ref(AF), RegisterBits::High)},
